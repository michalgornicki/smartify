        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container">
              <img className="opinion-avatar" src={avatar1} alt="" /><div className="opinion">Great job!</div>
              <img className="opinion-avatar" src={avatar1} alt="" /><div className="opinion">Very easy to set up</div>
              <img className="opinion-avatar" src={avatar1} alt="" /><div className="opinion">Life-changing</div>
            </div>
          </div>
        </div>
      </div>

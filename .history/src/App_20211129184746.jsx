...
import avatar4 from "./avatar0.png";
import avatar5 from "./avatar4.png";
import avatar6 from "./avatar4.png";
import avatar7 from "./avatar4.png";
import avatar8 from "./avatar4.png";
import avatar9 from "./avatar4.png";
import avatar10 from "./avatar4.png";
import avatar11 from "./avatar4.png";
import avatar12 from "./avatar4.png";
        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container">
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />I just love it</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar2} alt="" />Very professional product</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar3} alt="" />I'm fully satisfied</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar4} alt="" />It just work!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar5} alt="" />My friends use it too</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar6} alt="" />Nice!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar7} alt="" />Fantastic!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar8} alt="" />Very polished</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar9} alt="" />Plug and play</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar10} alt="" />Very easy to set up</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar11} alt="" />Life-changing</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar12} alt="" />Beautiful, simple, modern design</div>
            </div>
          </div>
        </div>
      </div>

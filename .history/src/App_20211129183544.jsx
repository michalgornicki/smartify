        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container">
              ...
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Very easy to set up</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Life-changing</div>
            </div>
          </div>
        </div>
      </div>

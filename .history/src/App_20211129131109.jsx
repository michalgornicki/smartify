  ...
  return (
    <div className="wrapper">
      ...
      <div className="container-5">
        <div className="text-and-image-container">
          <div className="text-container  center width-60">
            <div className="header font-medium text-center black">Kraftful Insights</div>
            <div className="footer black font-small">
              <p> Get in touch if you're curious to learn more about the research behind our white papers.
We love sharing what we learn.   </p>
      ...
      <div className="container-6">
        <div className="text-and-image-container">
          <div className="text-container  center width-60">
            ...
            <div className="footer black font-small">
              <p> Kraftful offers the only complete software solution that gets your product to market faster and keeps you ahead of the industry. </p>

              <div className="flex flex-wrap">
                <div className="text-container width-50"><img className="icon" src={connections} alt="" />
              <p>
                <div className="small-header">Other connected products</div>
                Our solution covers interfaces for a wide range of smart home
                appliances and we are constantly expanding our product offering.
              </p></div>
                <div className="text-container width-50">b</div>
                <div className="text-container width-50">c</div>
                <div className="text-container width-50">d</div>
              </div>

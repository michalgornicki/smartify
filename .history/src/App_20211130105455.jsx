...
import postPhoto1 from "./post-photo1.png";
import postPhoto1 from "./post-photo2.png";
import postPhoto1 from "./post-photo3.png";
            ...
            <div className="footer black font-small text-center">
              ...
              <div className="posts-container">
                <div className="post">
                  ...
                  <img className="image" src={postPhoto1} alt="" />
                </div>
                <div className="post">
                <div className="header black margin-top-3 font-medium">aaa</div>
                  <div className="footer black">bbb</div>

      ...
      <div className="container-2  light-gradient">
        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container"></div>
            <div className="opinion">Great job!</div>
            <div className="opinion">Very easy to set up</div>
            <div className="opinion">Life-changing</div>
          </div>
        </div>
      </div>
            ...
            <div className="footer black font-small text-center margin-bottom-10 width-60 margin-auto">
              ...
              <div className="flex flex-wrap margin-bottom-10">
                <div className="width-50 margin-bottom-10">
                  <img className="icon center background-blue" src={phones} alt="" />
                  <p>
                    <div className="small-header text-center">Other connected products</div>
                ...
                <div className="width-50 margin-bottom-10">
                  <img className="icon center background-green" src={cloud} alt="" />
                  <p>
                    <div className="small-header text-center">Other connected products</div>
                    Our solution covers interfaces for a wide range of smart
                    home appliances and we are constantly expanding our product
                ...
                <div className="width-50 margin-bottom-10">
                  <img className="icon center background-orange" src={analytics} alt="" />
                  <p>
                    <div className="small-header text-center">Other connected products</div>
                    Our solution covers interfaces for a wide range of smart
                    home appliances and we are constantly expanding our product
                ...
                <div className="width-50 margin-bottom-10">
                  <img className="icon center background-red" src={upgrade} alt="" />
                  <p>
                    <div className="small-header text-center">Other connected products</div>
                    Our solution covers interfaces for a wide range of smart
                    home appliances and we are constantly expanding our product

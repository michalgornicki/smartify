        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container">
              ...
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />I'm fully satisfied</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />It just work!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />My friends use it too</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Nice!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Fantastic!</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Very polished</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar1} alt="" />Plug and play</div>
              <div className="opinion"><img className="opinion-avatar" src={avatar2} alt="" />Very easy to set up</div>

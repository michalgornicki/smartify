...
import avatar1 from "./phones.png";
import avatar2 from "./phones.png";
import avatar3 from "./phones.png";
import avatar45 from "./phones.png";
        ...
        <div className="text-and-image-container">
          <div className="text-container center width-60">
            ...
            <div className="opinion-container">
              <img className="opinion-avatar" src="" alt="" /><div className="opinion">Great job!</div>

      ...
      <div className="container-5">
        <div className="text-and-image-container">
          <div className="text-container center  width-80">
            ...
            <div className="footer black font-small text-center width-60 center">
              <p>
                {" "}
              ...
              <div className="posts-container">
                <div className="post">
                  <div className="header black margin-top-3 font-medium  text-center">Announcing funding from Google, Y Combinator</div>
                  <div className="footer black  text-center margin-bottom-3">We kicked off 2020 by closing a funding round to bring usability to</div>
                  <img className="post-photo" src={postPhoto1} alt="" />
                </div>
                <div className="post">
                <div className="header black margin-top-3 font-medium text-center">Making Sense of Smart Home Integrations</div>
                  <div className="footer black font-small text-center margin-bottom-3">Like any product feature, an integration is only valuable when it</div>
                  <img className="post-photo" src={postPhoto2} alt="" />
                </div>
                <div className="post">
                <div className="header black margin-top-3 font-medium  text-center">Help us build the software layer for the physical world
</div>
                  <div className="footer black  text-center margin-bottom-3">We’re looking for a backend engineer to join our early team.</div>

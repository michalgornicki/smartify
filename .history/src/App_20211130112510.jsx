        ...
        <div className="text-and-image-container">
          <div className="text-container center  width-80">
            ...
            <div className="posts-container">
              <div className="post">
                <div className="height-50"><div className="header black margin-top-3 font-small  text-center">
                  Announcing funding from Google, Y Combinator
                </div>
                <div className="footer black font-smaller text-center margin-bottom-3 margin-top-3 ">
              ...
              <div className="height-50"><div className="header black margin-top-3 font-small  text-center">
                ...
                <div className="footer black font-smaller text-center margin-bottom-3">

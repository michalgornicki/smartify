  ...
  return (
    <div>
      ...
      <div className="container-2">
        <div className="text-and-image-container">
          <div className="text-container  center width-70">
            <div className="header font-big black center">Built for Hardware Companies</div>
        ...
        <div className="text-and-image-container light-gradient">
          <div className="text-container center width-70">
          <img className="image-rating" src={rating} alt="" />
            <div className="header font-big black">Thousands of delighted users</div>
            <div className="footer black font-small">
              <p> Kraftful makes your smart home devices delightful to use. </p>
              <p>Leading
              brands turn to Kraftful to get top-rated apps for their connected
      ...
      <div className="container-3">
        <div className="text-and-image-container">
          <div className="text-container  center width-70">
            <div className="header font-big black">UX for any smart home device</div>
            <div className="footer black font-small">
              <p> Kraftful makes your smart home devices delightful to use. </p>
              <p>Leading
              brands turn to Kraftful to get top-rated apps for their connected
        ...
        <div className="text-and-image-container">
          <div className="text-container  center width-70">
            <div className="header font-big black">Get to market faster and better</div>
            <div className="footer black font-small">
              <p> Kraftful makes your smart home devices delightful to use. </p>
              <p>Leading
              brands turn to Kraftful to get top-rated apps for their connected
        ...
        <div className="text-and-image-container">
          <div className="text-container  center width-70">
            <div className="header font-big black">Complete software solution</div>
            <div className="footer black font-small">
              <p> Kraftful makes your smart home devices delightful to use. </p>
              <p>Leading
              brands turn to Kraftful to get top-rated apps for their connected
